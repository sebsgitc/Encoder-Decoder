...
from attention_vit_unet import attention_vit_unet  # Import the new model
...
MODEL_PATH = "models/attention_vit_unet_model.h5"
...
# Create & compile Attention ViT U-Net Model
model = attention_vit_unet(input_shape=(IMG_HEIGHT, IMG_WIDTH, 1))
...
print(f"Attention ViT U-Net model saved to {MODEL_PATH}")