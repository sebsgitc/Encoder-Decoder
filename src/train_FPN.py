...
from FPN import fpn  # Import FPN model
from load_data import load_images  # Ensure data is properly loaded
...
model = fpn(input_shape=(256, 256, 3))  # Same input size as U-Net & ResUNet
